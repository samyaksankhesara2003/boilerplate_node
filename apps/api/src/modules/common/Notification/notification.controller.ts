...
const getNotifications = async (
  ...
  try {
    ...
    const data = await notificationService.getNotificationsService(
      query as INotificationQuery
    );
    return sendResponse(
      res,
      StatusCodes.SUCCESS,
      ResponseMessages.NOTIFICATION.FETCH_SUCCESS,
      data,
      language
    );
  } catch (error) {
...
const markAsRead = async (
  ...
  try {
    const { query, language } = req;
    const data = await notificationService.markAsReadService(
      query as unknown as INotificationMarkAsRead
    );
    return sendResponse(
      res,
      StatusCodes.SUCCESS,
      ResponseMessages.NOTIFICATION.LIST_SUCCESS,
      data,
      language
    );
  } catch (error) {
...
const getUnreadCount = async (
  ...
  try {
    const { query, language } = req;
    const data = await notificationService.getUnreadCountService(
      query as unknown as INotificationCount
    );
    return sendResponse(
      res,
      StatusCodes.SUCCESS,
