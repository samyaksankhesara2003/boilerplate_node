...
const getProfile = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        const data = await profileService.getProfile(user as IUser);
...
const updateProfile = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        const data = await profileService.updateProfile(user as IUser, body, file as Express.Multer.File);
...
const changePassword = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        const data = await profileService.changePassword(user as IUser, body);
...
const logout = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { user, body, language } = req;
        await profileService.logout(user as IUser, body);
