...
const list = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        const data = await staticPagesService.list(query as unknown as Query);
...
const createOrUpdate = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        const data = await staticPagesService.createOrUpdate(body);
...
const remove = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { params, language } = req;
        const data = await staticPagesService.remove(params.page);
